CREATE OR REPLACE TABLE company_financials (
    ...
    revenue           numeric(18,2),                 -- Revenue
    gross_profit      numeric(18,2),                 -- Gross Profit
    net_income        numeric(18,2),                 -- Net Income
    eps               numeric(18,2),                 -- Earnings Per Share
    ebitda            numeric(18,2),                 -- EBITDA
    shareholders_equity numeric(18,2),               -- Share Holder Equity (Total Equity)
    cash_flow_operating numeric(18,2),               -- Cash Flow from Operating Activities
    cash_flow_investing numeric(18,2),               -- Cash Flow from Investing Activities
    cash_flow_financing numeric(18,2),               -- Cash Flow from Financing Activities
    ...
    free_cash_flow    numeric(18,2),                 -- Free Cash Flow
